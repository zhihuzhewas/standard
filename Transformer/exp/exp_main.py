...
class Exp_Main(Exp_Basic):
    ...
    def _build_model(self):
        if self.args.type == 0:
            ...
            print('########################### performer')
            model = transformer.Model_performer(self.args).float()
    ...
    def _select_optimizer(self):
        ...
        if self.args.use_multi_gpu and self.args.use_gpu:
            model_optim = nn.DataParallel(optim.Adam(self.model.parameters(), lr=self.args.learning_rate), device_ids=self.args.device_ids)
        return model_optim
